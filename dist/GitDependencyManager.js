...
exports.GitDependencyManager = void 0;
...
class GitDependencyManager {
    static dependencyFilter(packagePath) {
            ...
            if (dependenciesData) {
                ...
                child_process_1.exec(`npm install`, (err, stdout, stderr) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (githubDepend.length > 0) {
                        yield this.manageGitDependency(githubDepend);
                    }
                }));
            }
        });
    }
    static manageGitDependency(gitDepend) {
        return __awaiter(this, void 0, void 0, function* () {
            if (gitToken === null || gitToken === undefined) {
                ...
                for (const val of gitDepend) {
                    ...
                    yield this.gitPullOrClone(localPath, pathParts[1]);
                    // List of tags
                    ...
                    if (tags.length > 0) {
                        ...
                        yield this.gitCheckout(maxVer, localPath);
                    }
                    yield this.dependencyFilter(`${localPath}/package.json`);
                }
            }
        });
    }
    static gitPullOrClone(localPath, repoPath) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static gitCheckout(tag, localPath) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.GitDependencyManager = GitDependencyManager;
GitDependencyManager.dependencyFilter(`${process.cwd()}/package.json`);
//# sourceMappingURL=GitDependencyManager.js.map